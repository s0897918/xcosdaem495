...
def inference(
    ...
    print(
        str(args.mini_batch_size).rjust(len('batch_size')) + ", " +
        "{:.0f}".format(mlp_bot_time*1000).rjust(len('mlp_bot(ms)')) + ", " +
...
def run():
    ...
    parser.add_argument(
        "--arch-embedding-size", type=dash_separated_ints, default="4" #4-3-2
    )
    ...
    if args.data_generation == "dataset":
        print ("input and target from dataset")
